...
public class Frame extends JFrame {
	...
	public void aggiornamento(){
		if(plancia != null) remove(plancia);
		if(tabellone != null) remove(tabellone);
		/*
		 ...
		 HashMap<String, model.Plancia> planciaModel = Client.getPlayersDashboard();
		 HashMap<String, model.Famigliare[]> famigliariModel = Client.getPlayersFamilies();
		 HashMap<String, model.Risorsa> risorseModel = Client.getPlayersResources();
		 HashMap<String, model.Punti> puntiModel = Client.getPlayersPoints();
		 model.SpazioAzione spazioAzioneModel = getGameBoard();
		 
		 
		 ArrayList<String> nomeGiocatori = new ArrayList<String>();
		 for(int i=0; i<planciaModel.size(); i++){
		...
		carteEdificio1.add("fiera"); carteEdificio1.add("banca"); carteEdificio1.add("palazzo");
		
		Giocatore g1 = new Giocatore("Pino", "rosso", new Punti(55,12,34), new Risorse(10,12,1,3), scomuniche1,
		...
		carteTerritorio2.add("avamposto commerciale"); carteTerritorio2.add("borgo"); carteTerritorio2.add("foresta");
		Giocatore g2 = new Giocatore("Bruno", "blu", new Punti(56,52,11), new Risorse(2,8,5,24), scomuniche2,
				fp2, carteTerritorio2, new ArrayList<String>(), new ArrayList<String>(), new ArrayList<String>());
		...
		cartePersonaggio3.add("artigiano"); cartePersonaggio3.add("badessa"); cartePersonaggio3.add("dama"); cartePersonaggio3.add("condottiero");
		...
		main.ui.gui.aggiornamento.Famigliare[] torre = { null, new main.ui.gui.aggiornamento.Famigliare(0, 0, "verde", "Beppe"), null, null, null, null, null, null, null, null, new main.ui.gui.aggiornamento.Famigliare(4, 2, "rosso", "Pino"), null, new main.ui.gui.aggiornamento.Famigliare(2, 3, "blu", "Bruno"), null, null, null };
		main.ui.gui.aggiornamento.Famigliare[] mercato = { null, null, new main.ui.gui.aggiornamento.Famigliare(0, 0, "verde", "Beppe"), null }; 
		main.ui.gui.aggiornamento.Famigliare raccoltoRotondo = new main.ui.gui.aggiornamento.Famigliare(0, 0, "verde", "Beppe");
		...
		main.ui.gui.aggiornamento.Famigliare produzioneRotondo = new main.ui.gui.aggiornamento.Famigliare(0, 0, "verde", "Beppe");
		...
		String[] carteTorre = { "citt�", "citt�", "citt�", "citt�", "citt�", "citt�", "citt�", "capitano", "citt�", "citt�", "citt�", "citt�", "citt�", "citt�", "citt�", "avamposto commerciale"};
		
		Aggiornamento agg = new Aggiornamento(5, giocatori, torre, mercato, raccoltoRotondo, 
	...
	public void setTabellone(Tabellone tabellone) { this.tabellone = tabellone; }
	
	public Plancia getPlancia() { return plancia; }
	
	public void setPlancia(Plancia plancia) { this.plancia = plancia; }
	
	public PlanciaAvversario getPlanciaAvversario() { return planciaAvversari; }
	
	public void setPlanciaAvversario(PlanciaAvversario planciaAvversario) { this.planciaAvversari =  planciaAvversario; }
	
	public String getNomeGiocatore() { return nomeGiocatore; }
	
	public String getColore() { return colore; }
	
	public int getNumeroGiocatori() { return numeroGiocatoriPartita; }
	
	public void aggiungiBottoni(){
		btnMostraTabellone.setBounds(961, 11, 127, 32); btnMostraTabellone.setText("TABELLONE");
		...
		btnMostraPlancia.setBounds(1093, 11, 127, 32); btnMostraPlancia.setText("PLANCIA");
		...
		btnMostraPlanciaAvversari.setBounds(1225, 11, 127, 32); btnMostraPlanciaAvversari.setText("AVVERSARI");
		...
		btnPassaTurno.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				scelte.add("4 legno"); scelte.add("2 pietre"); scelte.add("8 servitori");
	...
	public void aggiungiListenerCarteTorre(){
		...
		for(int i=0; i<carteTorre.size(); i++){
			if(carteTorre.get(i) != null) carteTorre.get(i).addMouseListener(new PrendiCarta());
		}
	}
	...
	public void aggiungiListenerMercatoTabellone(){
		...
		for(int i=0; i<mercato.length; i++) mercato[i].addMouseListener(new SpostamentoMercato());
	}
	...
	private class SpostamentoTorre implements MouseListener {
		...
		@Override
		public void mouseClicked(MouseEvent e) {
			if(famigliareSelezionato == null) return;
			int posizioneTorre=0;
			for(posizioneTorre=0; posizioneTorre<tabellone.getTorre().length; posizioneTorre++){
				if(tabellone.getTorre()[posizioneTorre] == (SpazioFamigliare)(e.getSource())) break;
			}
	...
	private class SpostamentoPalazzoDelConsiglio implements MouseListener {
		...
		public void mouseClicked(MouseEvent e) {
			...
			ArrayList<String> scelte = new ArrayList<String>();
			scelte.add("1 pietra e 1 legno"); scelte.add("2 servitori");
			scelte.add("2 monete"); scelte.add("2 punti militari");
			scelte.add("1 fede");
	...
	private class SpostamentoMercato implements MouseListener {
		...
		public void mouseClicked(MouseEvent e) {
			...
			for(posizioneMercato=0; posizioneMercato<tabellone.getMercato().length; posizioneMercato++){
				if(tabellone.getMercato()[posizioneMercato] == (SpazioFamigliare)(e.getSource())) break;
			}
			System.out.println("CHIAMATA A SERVER PER SPOSTAMENTO");
			System.out.println("FAMIGLIARE: "+famigliareSelezionato.getGiocatoreAppartenenza()+", numero: "
			+famigliareSelezionato.getNumero()+", valore: "+famigliareSelezionato.getValore());
	...
	private class PrendiCarta implements MouseListener {
		...
		public void mouseClicked(MouseEvent arg0) {
			...
			for(posizioneCarta = 0; posizioneCarta < tabellone.getCarteTorre().size(); posizioneCarta++){
				if(tabellone.getCarteTorre().get(posizioneCarta) == cartaSelezionata) break;
			}
