...
public enum EColoriGiocatori {
	RED(	ANSI.RED, 	ANSI.BACKGROUND_RED, 	"rosso"), 
	GREEN(	ANSI.GREEN,	ANSI.BACKGROUND_GREEN,	"verde"), 
	BLUE(	ANSI.BLUE,	ANSI.BACKGROUND_BLUE,	"blu"), 
	YELLOW(	ANSI.YELLOW,ANSI.BACKGROUND_YELLOW,	"giallo");
