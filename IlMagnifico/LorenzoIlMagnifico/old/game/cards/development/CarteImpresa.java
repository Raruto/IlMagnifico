package LorenzoIlMagnifico.old.game.cards.development;
...
public enum CarteImpresa {
	...
	private CarteImpresa(String nome, int periodo, int legna, int monete, int pietra, int servitori, int puntiFede,
			int puntiMilitari, int sogliaPuntiMilitari, int puntiVittoria, String nomeEffettoImmediato,
